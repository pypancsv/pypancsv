...
* All links you will need start with "https://link.stthomas.edu/**sfpy201820-**..."
...
## 1. [Starter Code:  "hello"](https://link.stthomas.edu/sfpy201810-hello){:target="_blank"}
[https://link.stthomas.edu/sfpy201810-hello](https://link.stthomas.edu/sfpy201810-hello){:target="_blank"}
...
## 2. [Starter Code:  "readcsv"](https://link.stthomas.edu/sfpy201810-readcsv){:target="_blank"}
[https://link.stthomas.edu/sfpy201810-readcsv](https://link.stthomas.edu/sfpy201810-readcsv){:target="_blank"}
...
## 3. [Starter Code:  "123"](https://link.stthomas.edu/sfpy201810-123){:target="_blank"}
[https://link.stthomas.edu/sfpy201810-123](https://link.stthomas.edu/sfpy201810-123){:target="_blank"}
...
* Close the tab where you performed exercise 3E and open [https://link.stthomas.edu/sfpy201810-123](https://link.stthomas.edu/sfpy201810-123){:target="_blank"} fresh in a new tab to start the "starter code" over.
  * _(Remember all the "fork" stuff when you first load the starter code!)_
* At the end of the program, add the following code and run the program:
```python
...
## 4. [Starter Code:  "filter1"](https://link.stthomas.edu/sfpy201810-filter1){:target="_blank"}
[https://link.stthomas.edu/sfpy201810-filter1](https://link.stthomas.edu/sfpy201810-filter1){:target="_blank"}
